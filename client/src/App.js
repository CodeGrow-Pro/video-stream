...
function App() {
  ...
  const [uploadOpenClass, setUploadOpenClass] = useState(false);
  ...
  return (
    <ThemeProvider theme={darkMode ? darkTheme : lightTheme}>
      <HashRouter basename="/">
        ...
        {uploadOpenClass && <DoubtClassRequestForm setUploadOpen={setUploadOpenClass} />}
        ...
        <Podstream>
          {menuOpen && <Menu setMenuOpen={setMenuOpen} darkMode={darkMode} setDarkMode={setDarkMode} setUploadOpen={setUploadOpen} setSignInOpen={setSignInOpen} setUploadOpenClass={setUploadOpenClass} />}
          <Frame>
