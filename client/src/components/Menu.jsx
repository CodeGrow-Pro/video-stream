...
const Image = styled.img`
  height: 40px;
`;
const Menu = ({ setMenuOpen, darkMode, setDarkMode, setUploadOpen, setUploadOpenClass = '' }) => {
    ...
    return (
        <MenuContainer setMenuOpen={setMenuOpen}>
            ...
            <Link to='/' style={{ textDecoration: "none", color: "inherit", width: '100%' }}>
                <Elements style={location.pathname === "/" ? activeStyle : {}}>
                    <HomeRoundedIcon />
                    <NavText>Home</NavText>
                </Elements>
            </Link>
            <Link to='/search' style={{ textDecoration: "none", color: "inherit", width: '100%' }}>
                <Elements style={location.pathname === "/search" ? activeStyle : {}}>
                    <SearchRoundedIcon />
                ...
                currentUser ?
                    <>
                        ...
                        <Link to='/favourites' style={{ textDecoration: "none", color: "inherit", width: '100%' }}>
                            <Elements style={location.pathname === "/favourites" ? activeStyle : {}}>
                                <FavoriteRoundedIcon />
